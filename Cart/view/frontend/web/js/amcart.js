define([
    ...
    $.widget('mage.amCart', {
        ...
        disableButton: function(form) {
            ...
            var addToCartButtonTextWhileAdding = this.options.addToCartButtonTextWhileAdding || transl('Adding...'),
        ...
        enableButton: function(form) {
            var addToCartButtonTextAdded = this.options.addToCartButtonTextAdded || transl('Added'),
                self = this,
                addToCartButton = $(form).find(this.options.addToCartButtonSelector);
                ...
                setTimeout(function () {
                    var addToCartButtonTextDefault = self.options.addToCartButtonTextDefault || transl('Add to Cart');
